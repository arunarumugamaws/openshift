...
+ Networking
+ Storage
+ Container Runtime Features (CRI-O)
+ Virtualization (CNV)
+ Deployment on various hardware platforms (ARM, Single Node, etc.)
+ Running other solutions on OpenShift
...
+ Architect and install an OpenShift environment.
+ Explain and utilize advanced tools for managing and monitoring OpenShift, such as CRI-O and Istio.
+ Explain integration options for development tools and how to install third-party applications on OpenShift (e.g., IBM, SAP, Microsoft).
...
https://rhepds.github.io/vILT-VMA/#/attendee?d=z1.eJytll1v2jAUhv_Kka86KawOH13JHS3dVvWDClpV6lRVbnJgFsaObAeGqv73KWErIc2hMI0LbmL5fc7x-_r4hT3NWRQGzKFz0mjHoh8vzEuvkEXsHlVsZghCJ3CuvTUsYElmhZdGX0mdeXQsCjsBc15Yfz4asIg1efOowduNsHXLv0ScR5x_5pw_sIChTurWhJ23Na_BWvwie0ar0aMr9Acp6tFPOfYwmKOdS1zUwRzxLTAlIQLmmII5184LpQqxPXWPd9DtUronw7PexZ5d7-4k2OK1gjdonXQetYeRN1ZMEAapL5xRQ9HeRtH66OxDTpV9jX5h7FTqCZwaPZaTP8KFE8y_8GxqETxh2a9lnjuHFq6EFhOc5a15gqFR2HgWDhMQcYzOQWzyhCg4GJ70Tj_V0bVIk2wqk3TEmRXRTLK46FBfLKG5j2PaO-S0vSWnuaBfmDygK0UHhzCKhZJ6EsBdmgiPAfSSROYfhYIxCp9ZrD1AKkdVAAKSzO8Kzlj4asUMc28VVvp-dnm1j4-qEgRGl_LR3nGubkYKUveHiKdZWtTal044jxaGGJs52uWehX94rbTzkBGFr2_vEcaZlX5P9c2dSfV2fReK5OaXSS9NlYxXV4nR4E0KZlwaLQffpB-kLoBTZbIEroWXcwzgRqaopEZXG2vas5tEBHVIUb-LdQv-_sIOzGTtIKKM1Nkh5Z0tKS_l997YqTIicXkL34_lFWCTk4RNol9VeQLx_83K6makIHHvrmvvJUmDGEldutoPR2Rny0i6xl_5iMbUgTcwW0V7TVR-sNRyUcOoqklylZvyGLDUokPt0d7KGT4YnTOeZdakeHiCVhVeeFszyoUvxTOqd68GzssL-2LZzDdkEav71qp8c1OZ9sUyf8WOhXIYlP4fX38Dc5Uhvg

### Day 1 (270 min total, plus Hands-On Lab)

+ Welcome and Intro (15 min)
+ Kubernetes and OpenShift Overview (60 min)
+ Installation (60 min)
...
+ Introduction Day 2 (15 min)
+ Day two Operations / Scaling, Update, Additional features (60 min)
+ Operator Framework and HELM (45 min)
+ Backup and Disaster Recovery (45 min)
...
+ Introduction Day 3 (15 min)
+ Additional Workloads on OpenShift Overview (120 min):
+ Virtualisation
+ AI
